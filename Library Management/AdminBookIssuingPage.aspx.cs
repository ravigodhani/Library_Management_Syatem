...
{
    public partial class AdminBookIssuingPage : System.Web.UI.Page
    {
        ...
        void returnBook()
        {
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    GridView_book_issuing.DataBind();
        ...
        void issueBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_issue_tbl(member_id,membar_name,book_id,book_name,issue_date,due_date) values(@member_id,@member_name,@book_id,@book_name,@issue_date,@due_date)", con);
